...
@Component({
  ...
  styleUrls: ['./website-pages-results.component.css']
})
export class WebsitePagesResultsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    for (let h in this.comboio) {
      for (let t in this.comboio[h]) {
        ...
        let quartiles = this.calculateQuartiles(this.getErrorOcurrenceByPage(test));
